...
//import com.example.campuswheels.core.util.GsonUtil
import com.example.campuswheels.core.util.LoggerUtil
import com.example.campuswheels.core.util.Resource
//import com.example.campuswheels.core.util.SocketEvent
...
//            try{
//                if(socket==null){
//                    val userId = userPrefsRepository.getUserId.first()
//                    logger.info("userId = $userId", "connectSocket")
//                    if (userId.isNotEmpty()) {
//                        socket = IO.socket("${Constants.socketBaseUrl}/user?userId=$userId")
//                    }
//                }
//                socket?.connect()
